                    ...
                    <div class="contacts__content-inner">
                        ...
                        <div class="contacts__phone-list">
                            <div class="contacts__phone-link-wrap contacts__phone-link-wrap-icon">
                                ...
                                <a href="tel:<?php the_field("phone_number_1_link", 'option'); ?>" class="contacts-link"><?php the_field("phone_number_1", 'option'); ?></a>
                            </div>
                            <div class="contacts__phone-link-wrap">
                                <div class="contacts__line"></div>
                                <a href="tel:<?php the_field("phone_number_2_link", 'option'); ?>" class="contacts-link"><?php the_field("phone_number_2", 'option'); ?></a>
                            </div>
                            <div class="contacts__phone-link-wrap">
                                <div class="contacts__line"></div>
                                <a href="tel:<?php the_field("phone_number_3_link", 'option'); ?>" class="contacts-link"><?php the_field("phone_number_3", 'option'); ?></a>
                            </div>
                            <div class="contacts__phone-link-wrap">
                                <div class="contacts__line"></div>
                                <a href="tel:<?php the_field("phone_number_4_link", 'option'); ?>" class="contacts-link"><?php the_field("phone_number_4", 'option'); ?></a>
                            </div>
                        </div>
                        <div class="contacts__link-list">
                            <div class="contacts__link-item">
                                ...
                                <a href="mailto: <?php the_field("mail", 'option'); ?>" class="contacts-link"><?php the_field("mail", 'option'); ?></a>
                            </div>
                            <div class="contacts__link-item">
                                <div>
                                    <svg width="24px" height="24px">
                                ...
                                <a href="tel:<?php the_field("phone_number_6_link", 'option'); ?>" class="contacts-link">
